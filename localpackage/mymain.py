...
eg={"rows": rows, 'game': {"trialDate":datetime(1990,11,21),"projection":True,"autoYrAttained": True, "discountRate": -0.25/100, "Ogden": 7, "claimants": [c1,c2]}}
...
print(g.getClaimant('JONNIE').M(30,125, freq='Y',options='AMI'))
