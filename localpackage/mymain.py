...
c3={"name":"Mason","cont":1,"dob":'20/10/2001', 'deltaLE':-3.5, "sex":"Male",'fatal':False,"dataSet":Ogden8, "contDetails":contDetails}
...
eg={"rows": rows, 'game': {"trialDate":datetime(2022,2,7),"projection":True,"autoYrAttained": False, "discountRate": -0.25/100, "Ogden": 8, "claimants": [c1,c2, c3]}}
...
#print(g.process())
print(g.getClaimant('Gadsden').M('TRIAL','TRIAL+20Y', freq='Y',options='A'))
print(g.getClaimant('Mason').REVERSION('TRIAL+2.5Y',"LIFE"))
