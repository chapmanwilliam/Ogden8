...
c1={"name":"Jonnie","cont":1,"dob":'27/2/2005', 'deltaLE':0, "sex":"Male", 'dod':'13/4/2021','fatal':False,"dataSet":Ogden8, "contDetails":contDetails}
...
g=game(eg)
#print(g.processRows())
print(g.getClaimant('Jonnie').M('TRIAL','LIFE', freq='Y',options='AMI'))
