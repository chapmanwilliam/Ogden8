...
eg = {"rows": [], 'game': {"trialDate": datetime(2022, 7, 31), "DOI": datetime(2012,7,31), "projection": True, 'useTablesEF': True, "autoYrAttained": False,
...
print(g.getClaimant('Jacqueline').M('INJURY','TRIAL','Y','AMID'))
print(g.getClaimant('Jacqueline').JM('INJURY','TRIAL',"Y","AM"))
