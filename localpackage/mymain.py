...
claimant = {'age': 55, 'aai': 25, 'sex': 'Female', 'dataSet': Ogden7, 'deltaLEB': 0, 'deltaLEA': -15}
...
g=game(eg)
print(g.claimants[0].MB(55,70, options='AMI'))
print(g.claimants[0].MA(55,70, options='AMI'))
