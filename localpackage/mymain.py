...
eg={"rows": rows, 'game': {"trialDate":datetime(2021,3,23),"projection":True,"autoYrAttained": False, "discountRate": -0.25/100, "Ogden": 8, "claimants": [c1,c2]}}
...
print(g.getClaimant('PRIYA').M('TRIAL',125, freq='Y',options='AMI'))
