...
eg={"rows": rows, 'game': {"trialDate":datetime(2022,8,25),"projection":True,"autoYrAttained": False, "discountRate": -0.25/100, "Ogden": 8, "claimants": [claimant, dependent1,nondependent3]}}
...
print(g.getClaimant('Norman').gettermCertain(90,100-0.0025))
