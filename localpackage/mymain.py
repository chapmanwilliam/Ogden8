...
c1={"name":"Christopher1","cont":1,"age":60,'aad':50, 'deltaLE':0,"sex":"Male","dataSet":Ogden8}
...
eg={"rows": rows, 'game': {"autoYrAttained": False, "discountRate": -0.005, "Ogden": 7, "claimants": [c1,c2,dependent1,dependent2]}}
...
print(g.getClaimant('JOHN1').M(20,125, freq='Y',options='D'))
